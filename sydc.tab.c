...
static const yytype_uint8 yyprhs[] =
{
      ...
      21,    25,    28,    31,    37,    45,    50,    52,    54,    58,
      62,    64,    68,    72,    74,    78,    82,    86,    88
};

/* YYRHS -- A `-1'-separated list of the rules' RHS.  */
static const yytype_int8 yyrhs[] =
{
      24,     0,    -1,    25,    -1,    25,    22,    26,    -1,    26,
      -1,    27,    -1,    30,    -1,    31,    -1,    28,    -1,    29,
      -1,     4,    13,    32,    -1,     5,     4,    -1,     6,     4,
      -1,     7,    32,     8,    25,    10,    -1,     7,    32,     8,
      25,     9,    25,    10,    -1,    11,    25,    12,    32,    -1,
      33,    -1,    34,    -1,    33,    14,    34,    -1,    33,    15,
      34,    -1,    35,    -1,    34,    16,    35,    -1,    34,    17,
      35,    -1,    36,    -1,    35,    18,    36,    -1,    35,    19,
      36,    -1,    20,    32,    21,    -1,     3,    -1,     4,    -1
};

/* YYRLINE[YYN] -- source line where rule number YYN was defined.  */
static const yytype_uint8 yyrline[] =
{
       0,    37,    37,    45,    49,    56,    57,    58,    59,    60,
      64,    71,    78,    85,    89,    96,   103,   110,   111,   115,
     122,   123,   127,   134,   135,   139,   146,   150,   156
};
#endif
...
{
  "$end", "error", "$undefined", "DEC_CONST", "ID", "READ", "WRITE", "IF",
  "THEN", "ELSE", "END", "REPEAT", "UNTIL", "AS", "LT", "EQ", "PLUS",
  "MINUS", "TIMES", "DIVIDE", "LPAREN", "RPAREN", "SEMICOLON", "$accept",
  "program", "stmt_seq", "stmt", "assign_stmt", "read_stmt", "write_stmt",
  "if_stmt", "repeat_stmt", "exp", "rel_exp", "simple_exp", "term",
  "factor", 0
};
#endif
...
{
       0,     0,     0,     0,     0,     0,     0,     2,     4,     5,
       8,     9,     6,     7,     0,    11,    12,    27,    28,     0,
       0,    16,    17,    20,    23,     0,     1,     0,    10,     0,
       0,     0,     0,     0,     0,     0,     0,     0,     3,    26,
       0,    18,    19,    21,    22,    24,    25,    15,     0,    13,
       0,    14
};
...
{
       6,    -4,    14,    19,    -1,     6,    28,    -8,   -14,   -14,
     -14,   -14,   -14,   -14,    -1,   -14,   -14,   -14,   -14,    -1,
      25,     7,    10,    11,   -14,    -7,   -14,     6,   -14,    15,
       6,    -1,    -1,    -1,    -1,    -1,    -1,    -1,   -14,   -14,
      -2,    10,    10,    11,    11,   -14,   -14,   -14,     6,   -14,
      -6,   -14
};
...
{
      25,    28,    17,    18,    51,    37,    29,    48,    49,    14,
       1,     2,     3,     4,    27,    27,    27,     5,    15,    19,
      27,    31,    32,    16,    47,    40,    33,    34,    26,    35,
      36,    41,    42,    30,    43,    44,    39,    45,    46,    38,
       0,     0,     0,    50
};

static const yytype_int8 yycheck[] =
{
       5,    14,     3,     4,    10,    12,    19,     9,    10,    13,
       4,     5,     6,     7,    22,    22,    22,    11,     4,    20,
      22,    14,    15,     4,    37,    30,    16,    17,     0,    18,
      19,    31,    32,     8,    33,    34,    21,    35,    36,    27,
      -1,    -1,    -1,    48
};
...
{
       0,     4,     5,     6,     7,    11,    24,    25,    26,    27,
      28,    29,    30,    31,    13,     4,     4,     3,     4,    20,
      32,    33,    34,    35,    36,    25,     0,    22,    32,    32,
       8,    14,    15,    16,    17,    18,    19,    12,    26,    21,
      25,    34,    34,    35,    35,    36,    36,    32,     9,    10,
      25,    10
};
...
#line 37 "sydc.y"
    { 
        (yyval.node) = create_node(NODE_PROGRAM, (yyvsp[(1) - (1)].node), NULL, NULL);
        root = (yyval.node);  // program node as the roof of ast
...
#line 45 "sydc.y"
    {
        (yyval.node) = create_node(NODE_SEQ, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), NULL);  
...
#line 64 "sydc.y"
    {
        (yyval.node) = create_node(NODE_ASSIGNMENT, create_node(NODE_ID, NULL, NULL, (yyvsp[(1) - (3)].ystr)), (yyvsp[(3) - (3)].node), NULL); 
...
#line 71 "sydc.y"
    {
        (yyval.node) = create_node(NODE_READ, NULL, NULL, strdup((yyvsp[(2) - (2)].ystr))); 
...
#line 78 "sydc.y"
    {
        (yyval.node) = create_node(NODE_WRITE, NULL, NULL, strdup((yyvsp[(2) - (2)].ystr))); 
...
#line 85 "sydc.y"
    {
        (yyval.node) = create_node(NODE_IF, (yyvsp[(2) - (5)].node), (yyvsp[(4) - (5)].node), NULL); 
...
#line 89 "sydc.y"
    {
        (yyval.node) = create_node(NODE_IF, (yyvsp[(2) - (7)].node), create_node(NODE_ELSE, (yyvsp[(4) - (7)].node), (yyvsp[(6) - (7)].node), NULL), NULL); 
...
#line 96 "sydc.y"
    {
        (yyval.node) = create_node(NODE_REPEAT, (yyvsp[(2) - (4)].node), (yyvsp[(4) - (4)].node), NULL); 
...
#line 111 "sydc.y"
    {
        (yyval.node) = create_node(NODE_LT, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), NULL);  
...
#line 115 "sydc.y"
    {
        (yyval.node) = create_node(NODE_EQ, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), NULL);  
        fprintf(logFile, "Bison: Created rel_exp with '='\n");
    ;}
    break;
...
#line 123 "sydc.y"
    {
        (yyval.node) = create_node(NODE_ADD, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), NULL);  
...
#line 127 "sydc.y"
    {
        (yyval.node) = create_node(NODE_SUBTRACT, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), NULL);  
        fprintf(logFile, "Bison: Created simple_exp with '-'\n");
    ;}
    break;
...
#line 135 "sydc.y"
    {
        (yyval.node) = create_node(NODE_MULTIPLY, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), NULL);  
...
#line 139 "sydc.y"
    {
        (yyval.node) = create_node(NODE_DIVIDE, (yyvsp[(1) - (3)].node), (yyvsp[(3) - (3)].node), NULL);  
        fprintf(logFile, "Bison: Created term with '/'\n");
    ;}
    break;
...
#line 150 "sydc.y"
    {
        ...
        (yyval.node) = create_node(NODE_NUMBER, NULL, NULL, strdup(buffer));  
...
#line 156 "sydc.y"
    {
        (yyval.node) = create_node(NODE_ID, NULL, NULL, strdup((yyvsp[(1) - (1)].ystr)));  
